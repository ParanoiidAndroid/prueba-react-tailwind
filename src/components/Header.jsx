...
export default function Header() {
  ...
  const [menuOpen, setMenuOpen] = useState(false); // Estado para manejar la apertura/cierre del menu mobile
    ...
    <header className="bg-gradient-to-r from-gray-800 via-gray-700 to-gray-400 p-4 text-white fixed top-0 w-full z-50">
      ...
      <nav className="flex flex-col md:flex-row justify-between items-center max-w-screen-lg mx-auto">
        ...
        <button
          ...
          onClick={() => setMenuOpen(!menuOpen)} // Cambia el estado del menú (abierto o cerrado)
        >
          <svg
          ...
          >
            ...
            <path
              ...
              className={`${menuOpen ? "opacity-0" : "opacity-100"}`} // Oculta lineas al abrir el menu
            />
